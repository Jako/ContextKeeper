...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install ContextKeeper</h2>

        <p>Thanks for installing ContextKeeper. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade ContextKeeper</h2>

        <p>ContextKeeper will be upgraded. This open source extra was developed by
