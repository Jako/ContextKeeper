...
|----------------------------------------|--------------------------|--------------------------------------------------------------------------------------------------------|---------|
| contextkeeper.check_empty              | Check Empty              | Test the write restriction even if the the system/usergroup/user setting `writable_contexts` is empty. | No      |
| contextkeeper.debug                    | Debug                    | Log debug information in the MODX error log.                                                           | No      |
| contextkeeper.disable_duplicate_button | Disable Duplicate Button | Disable the duplicate button in resources of not writable contexts.                                    | No      |
| contextkeeper.writable_contexts        | Writable Contexts        | Comma-separated list of keys of writable contexts.                                                     | -       |
